                    ...
                    <div className='div-for-cards'>
                        ...
                        <div className='card-divs'>
                            ...
                            <img
                                ...
                                className='logoes-on-hover' />
                            <p>ჯანმრთელობის <br></br> დაზღვევა</p>
                            <button className='sheidzineDiv'>შეიძინე</button>
                        </div>
                        <div className='card-divs'>
                            <img
                            ...
                            <img
                                ...
                                className='logoes-on-hover' />
                            <p>ავტომობილის <br></br> დაზღვევა</p>
                            <button className='sheidzineDiv'>შეიძინე</button>
                        </div>
                        <div className='card-divs'>
                            <img
                            ...
                            <img
                                ...
                                className='logoes-on-hover' />
                            <p>პასუხისმგებლობის <br></br> დაზღვევა</p>
                            <button className='sheidzineDiv'>შეიძინე</button>
                        </div>
                        <div className='card-divs'>
                            <img
                            ...
                            <img
                                ...
                                alt='auto insurance on hover'
                                className='logoes-on-hover' />
                            <p>სამოგზაურო <br></br> დაზღვევა</p>
                            <button className='sheidzineDiv'>შეიძინე</button>
                        </div>
                        <div className='card-divs' id='just-for-mobile'>
                            <img
                                src={cart}
                                alt='cart logo'
                                className='logoes' />
                            <p>შეიძინე <br></br>ონლაინ</p>
                            <button className='sheidzineDiv'>შეიძინე</button>
                        </div>
                        <div className='sos-secondiv'>SOS</div>
                    </div>
                </div>
